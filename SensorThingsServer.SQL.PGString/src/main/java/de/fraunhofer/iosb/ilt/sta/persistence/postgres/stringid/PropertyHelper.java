...
public class PropertyHelper {
    ...
    public static class DatastreamFactory implements PropertyHelper.entityFromTupleFactory<Datastream> {
        ...
        public Datastream create(ResultSet resultSet, Query query, DataSize dataSize) throws SQLException {
            ...
            String id = resultSet.getString(qInstance.getMetadata(qInstance.id).getName());
            ...
            ObservedProperty op = observedProperyFromId(resultSet.getString(qInstance.getMetadata(qInstance.obsPropertyId).getName()));
            ...
            entity.setSensor(sensorFromId(resultSet.getString(qInstance.getMetadata(qInstance.sensorId).getName())));
            entity.setThing(thingFromId(resultSet.getString(qInstance.getMetadata(qInstance.thingId).getName())));
    ...
    public static class ObservationFactory implements PropertyHelper.entityFromTupleFactory<Observation> {
        ...
        public Observation create(ResultSet resultSet, Query query, DataSize dataSize) throws SQLException {
            ...
            String dsId = resultSet.getString(qInstance.getMetadata(qInstance.datastreamId).getName());
            entity.setDatastream(datastreamFromId(dsId));
            String mDsId = resultSet.getString(qInstance.getMetadata(qInstance.multiDatastreamId).getName());
            entity.setMultiDatastream(multiDatastreamFromId(mDsId));

            String foiId = resultSet.getString(qInstance.getMetadata(qInstance.featureId).getName());
     ...
     * PathSqlBuilderString.ALIAS_PREFIX + "1".
     *
